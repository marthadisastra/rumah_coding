...
<head>
    ...
    <title><?= esc($page['title'] ?? 'Syarat dan Ketentuan') ?> - Rumah Coding</title>
    ...
    <style>
        ...
        .content-area p { margin-bottom:20px; text-align:justify; }
...
<body>
    ...
    <div class="page-header">
        <div class="container">
            <h1 class="fw-bold mb-3 text-dark" style="font-size:2.5rem;letter-spacing:-0.02em;">
                <?= esc($page['title'] ?? 'Syarat dan Ketentuan Layanan') ?>
            </h1>
    ...
    <footer class="footer">
        <div class="container text-center text-muted" style="font-size:0.85rem;">
            ...
            &nbsp;|&nbsp;
            <a href="/privacy-policy" class="text-muted text-decoration-none">Kebijakan Privasi</a>
        </div>
    </footer>
</body>
</html>
